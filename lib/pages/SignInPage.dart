...
class _SignInPageState extends State<SignInPage> {
    ...
    return InkWell(
      onTap: () async{
        setState(() {
         ...
         try{
           firebase_auth.UserCredential userCredential =await firebaseAuth.signInWithEmailAndPassword(email: _emailController.text, password:_passwordController.text);
      ...
      child: Container(
        ...
        child: Card(
          ...
          child: Row(
            mainAxisAlignment: MainAxisAlignment.center,
            children:[
              Icon(icons,size: 30,color: Colors.red,),
              SizedBox(width: 15.0,),
  ...
  Widget textItem(String labletxt, TextEditingController controller,bool obscureText){
    return Container(
